...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('halls_fooditem', (
            ...
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['halls.FoodCategory'])),
        ))
    ...
    models = {
        ...
        'halls.fooditem': {
            ...
            'attributes': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['halls.FoodAttribute']", 'symmetrical': 'False'}),
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['halls.FoodCategory']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
